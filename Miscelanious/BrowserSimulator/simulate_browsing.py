...
def simulate_browsing():
    ...
    with open('config.json') as config_file:
        ...
        distribute_requests(request_count, distribution, cloudfront_domain, s3_bucket, images)


def distribute_requests(request_count, distribution, cloudfront_domain, s3_bucket, images):
    total_cf = 0
    total_s3 = 0
    index = 0
